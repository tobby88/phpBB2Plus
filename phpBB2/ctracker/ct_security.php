...
if ( !defined('IN_PHPBB') )
{
 ...
 //
 $ct_rules = array('%2527', '%2e', 'chr(', 'chr=', 'chr%20', '%20chr', 'wget%20', '%20wget', 'wget(',
                   ...
                   'root_path', '_globals', 'globals_', 'globals[', 'iso-8859-1', '?hl=', '.txt', '.exe');
  ...
  if($cracktrack != $checkworm)
  {
    ...
    {
      $clog = @fopen($phpbb_root_path . "ctracker/logs/logfile_worms.txt", "a") or die("Error opening logfile.");
    ...
    die("<br><hr width=\"40%\" align=\"left\"><font color=\"#FF0F0F\" face=\"Verdana\" size=\"5\"><b>- SECURITY ALERT -</b></font><hr width=\"40%\" align=\"left\">
         ...
         bring bad<br>Code to this Forum or you have tried to exploit something here or maybe<br>another attack like this.
         <br><br>
