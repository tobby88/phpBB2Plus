...
// Historical unbound reset marker, retained for compatibility/upgrade detection.
// New requests use credential-bound markers from phpbb_reset_binding().
...
define('PROFILE_FIELD_ACTIONS_TABLE', $table_prefix.'profile_field_actions');
