...
// End add - Birthday MOD
	if ( !$error )
	{
		...
		else
		{
			...
			list($profile_columns, $profile_values) = $registration_scope->profile_insert_parts($profile_names);
			$registration_extra_columns .= $profile_columns;
			$registration_extra_values .= $profile_values;
