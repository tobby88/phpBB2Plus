	...
	<td width="25%" class="{row.COLOR}" align="center">
		...
		<tr>
			...
			<td rowspan="2">
				...
				<tr>
					<td><table cellpadding="2" cellspacing="0" border="1" align="center"><tr><td class="quote" align="center"><a href="{row.U_MOVEUP}" class="genmed" title="{L_MOVEUP}"><img src="{IMG_MOVEUP}" border="0" /></a></td></tr></table></td>
				</tr>
				<tr>
					<td><table cellpadding="2" cellspacing="0" border="1" align="center"><tr><td class="quote" align="center"><a href="{row.U_MOVEDW}" class="genmed" title="{L_MOVEDW}"><img src="{IMG_MOVEDW}" border="0" /></a></td></tr></table></td>
				</tr>
				</table>
			</td>
		</tr>
