...
<tr> 
<td align="center" ><a href="{U_FORUM_INDEX}" target="_parent"><img src="../templates/fisubsilversh/images/logo_phpbb_med.gif" alt="" width="122" height="56" vspace="4" border="0" /></a></td>
  </tr>
  <tr> 
	<td align="center" > 
...
<tr> 
<td class="row1"><a href="{U_PORTAL_PREVIEW}" target="main" class="genmed">{L_PREVIEW_PORTAL}</a></td>
</tr>
<tr> 
<td class="row1"><a href="http://www.phpbb2.de/" target="_new" class="genmed">phpBB2.de</a></td> 
</tr>
<!-- BEGIN catrow -->
<tr> 
