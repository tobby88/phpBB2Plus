...
<form action="{S_ACTION}" method="post">
	  <td align="right" width="100%">{L_CREATE_CAT} &nbsp; <input type="text" name="new_cat_name"> {S_HIDDEN_FIELDS} &nbsp; <input type="submit" value="{L_CREATE}" class="liteoption"></td>
</form>
	</tr>
</table>
...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
	...
	<!-- BEGIN subrow -->
	<tr> 	
	  <td class="{catrow.subrow.ROW_CLASS}"><span class="gen">{catrow.subrow.INDENT}{catrow.subrow.CATEGORY}<br />{catrow.subrow.INDENT}{catrow.subrow.CAT_DESCRIPTION}</span></td>
