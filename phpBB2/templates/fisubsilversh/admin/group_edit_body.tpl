...
<td class="row2"> 
<input type="text" class="post" name="username" id="username" maxlength="50" size="20" value="{GROUP_MODERATOR}" onkeyup="AJAXUsernameSearch(this.value, 0);" /><span id="username_list" style="display:none;"><span id="username_select">&nbsp;</span>&nbsp;</span>
&nbsp; 
...
<tr> 
<td class="row1">{L_PM_QUOTA}</span></td>
