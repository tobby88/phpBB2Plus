...
<form method="post" action="{S_ATTACH_ACTION}">
  <table width="99%" align="center" cellpadding="4" cellspacing="1" border="0" class="forumline">
	...
	<tr align="right">
	  <td class="cat" colspan="5" height="29"> {S_HIDDEN_FIELDS} <input type="submit" name="submit" class="liteoption" value="{L_SUBMIT}" /></td>
	</tr>
	<tr>
		<th class="thCornerL">{L_DESCRIPTION}</th>
		<th class="thTop">{L_SIZE}</th>
...
<!-- END limit_row -->
	<tr align="right">
	  <td class="cat" colspan="5" height="29"> <input type="submit" name="submit" class="liteoption" value="{L_SUBMIT}" /></td>
	</tr>
</table>
</form>
