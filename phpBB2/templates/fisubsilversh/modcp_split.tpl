...
<tr>
<td class="nav"><a href="{U_INDEX}">{L_INDEX}</a> {NAV_CAT_DESC} &raquo; {L_SPLIT_TOPIC}</td>
</tr>
</table>
...
<tr>
<td class="postdetails"><img src="templates/fisubsilversh/images/icon_minipost.gif" alt="{L_POST}" title="{L_POST}" width="12" height="9" />{L_POSTED}: 
