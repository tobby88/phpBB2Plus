...
<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
	<tr> 
    <td align="left" nowrap="nowrap"><span class="gen">{L_SEARCH}:&nbsp;<input class="post" type="text" size="40" name="search_word" value="{SEARCH_WORD}" />&nbsp;&nbsp;<input type="submit" name="search" value="{L_SUBMIT}" class="liteoption" /></span></td>
