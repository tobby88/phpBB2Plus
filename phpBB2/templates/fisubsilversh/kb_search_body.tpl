...
<form action="{S_SEARCH_ACTION}" method="POST"><table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
	<tr> 
		<td align="left"><span class="nav"><a href="{U_PORTAL}" class="nav">{L_PORTAL}</a></span></td>
	</tr>
</table>
...
<table class="forumline" width="100%" cellpadding="4" cellspacing="1" border="0">
	...
	<tr> 
		<td class="cat" colspan="4" align="center" height="28">{S_HIDDEN_FIELDS}<input class="liteoption" type="submit" value="{S_SEARCH}" /></td>
	</tr>
</table>
