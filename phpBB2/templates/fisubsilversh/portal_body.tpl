...
<tr> 
<td width="14%" valign="top"><table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
<tr> 
...
<img src="templates/fisubsilversh/images/arrow.gif" alt="{L_CATEGORIES}" width="14" height="9" />&nbsp;<a href="{INDEX_FILE}?news=categories" alt="Index">{L_CATEGORIES}</a><br />
<img src="templates/fisubsilversh/images/arrow.gif" alt="{L_ARCHIVES}" width="14" height="9" />&nbsp;<a href="{INDEX_FILE}?news=archives" alt="Index">{L_ARCHIVES}</a><br />
...
<!-- BEGIN switch_recent_exp -->
<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
<tr>
<th>{L_RECENT_TOPICS}</th>
</tr>
<!-- END switch_recent_exp -->
<!-- BEGIN switch_recent_topics_yes -->
<tr>
<td class="row1" align="left"><span class="gensmall">
<!-- BEGIN recent_topic_row -->
<img src="templates/fisubsilversh/images/arrow.gif" alt="" width="14" height="9" />&nbsp;<a href="{switch_recent_topics_yes.recent_topic_row.U_TITLE}">{switch_recent_topics_yes.recent_topic_row.L_TITLE}</a><br />
{L_WORD_BY} <a href="{switch_recent_topics_yes.recent_topic_row.U_POSTER}">{switch_recent_topics_yes.recent_topic_row.S_POSTER}</a> {L_WORD_ON} {switch_recent_topics_yes.recent_topic_row.S_POSTTIME}<br /><br />
...
<br />
<!-- END switch_recent_exp -->
<!-- BEGIN switch_recent_files -->
<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
<tr>
<th>{L_RECENT_FILES}</th>
</tr>
<!-- END switch_recent_files -->
...
<!-- BEGIN lastvisits -->
<tr>
<td class="row1"><span class="gensmall">{L_USERS_TODAY}&nbsp;{L_USERS_LASTHOUR}<br /></span></td>
</tr>
<!-- END lastvisits -->
<!-- BEGIN last_seen_row -->
<tr>
