...
<td class="cat" colspan="7">
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
 	<tr>
 		<td>
<input type="text"  class="post" name="username" id="username" maxlength="50" size="20" onkeyup="AJAXUsernameSearch(this.value, 0);" />
<span id="username_list" style="display:none;">&nbsp;<span id="username_select">&nbsp;</span></span><input type="submit" name="add" value="{L_ADD_MEMBER}" class="mainoption" />
...
</span><br /><span id="username_error_tbl" style="display:none;"><span id="username_error_text" class="gen">&nbsp;</span></td>
