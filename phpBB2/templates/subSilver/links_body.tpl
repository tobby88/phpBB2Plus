	...
	<tr> 
	  ...
	  <td width="200" nowrap="nowrap" valign="top">
		...
		<tr>
		  ...
		  <tr>
			<td class="row1" align="center"><input type="hidden" name="redirect" value="{U_SITE_LINKS_CAT}" /><input type="submit" name="login" class="mainoption" value="{L_LOGIN}" /><br /><br /><span class="gensmall"><a href="{U_REGISTER}">{L_REGISTER}</a></span></td>
		  </tr>
		</table></form>
		</td></tr>
		</table>
		...
		<table border="0" cellpadding="2" cellspacing="0" width="100%">
			...
			<tr> 
			  <td class="row1">
				...
				<select name="link_category" style="width:160px">{LINK_CAT_OPTION}</select>
			  </td>
			</tr>
			<tr> 
	  ...
	  <td width="100%" nowrap="nowrap" valign="top">
		...
		<tr>
			  <th class="thHead" align="left" nowrap="nowrap" colspan="2">&nbsp;{L_LINK_CATEGORY} &raquo; {LINK_CATEGORY}</th>
		</tr>
		<tr>
		...
		<tr>
		<td class="{linkrow.ROW_CLASS}" align="center"><span class="genmed">{L_LINK_JOINED}: {linkrow.LINK_JOINED}&nbsp;&nbsp;,&nbsp;{L_LINK_HITS}: {linkrow.LINK_HITS}&nbsp;&nbsp;,&nbsp;{L_LINK_SUBMITER}&nbsp;{linkrow.U_LINK_USER}</span></td>
		</tr>
		<!-- END linkrow -->
		</table><br />
