...
<form action="{S_PROFILE_ACTION}" {S_FORM_ENCTYPE} method="post"><table width="98%" cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
	...
	<tr> 
	  ...
	  <td class="row2"> 
		<input class="post" type="password" name="password" size="35" maxlength="128" value="" autocomplete="new-password" />
	  </td>
	</tr>
	<tr> 
	  ...
	  <td class="row2"> 
		<input class="post" type="password" name="password_confirm" size="35" maxlength="128" value="" autocomplete="new-password" />
	  </td>
	</tr>
	<tr> 
