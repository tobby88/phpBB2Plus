...
<table width="100%" cellspacing="1" cellpadding="3" border="0" class="forumline">
	...
	<tr> 
		<td class="row1" align="center" width="50%"><form action="{S_ACTION_OPTION_1}" method="post">{S_FORM_TOKEN}<input type="hidden" name="action" value="scan" /><button type="submit" class="liteoption"><img src="{IMG_ICON_1}" border="0" alt="{L_ALT_TEXT}" title="{L_ALT_TEXT}"><br />{L_OPTION_1}</button></form></td>
