...
<table width="100%" cellpadding="2" cellspacing="2">
  <tr>
	<td valign="bottom">
		<span class="nav"><a href="{U_INDEX}" class="nav">{L_INDEX}</a> &raquo; <a href="{U_DOWNLOAD_HOME}" class="nav">{DOWNLOAD}</a><!-- BEGIN navlinks --> &raquo; <a href="{navlinks.U_VIEW_CAT}" class="nav">{navlinks.CAT_NAME}</a><!-- END navlinks --> &raquo; <a href="{U_FILE_NAME}" class="nav">{FILE_NAME}</a> &raquo; {L_COMMENT_ADD}</span>
	</td>
  </tr>
</table>
