...
<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
  ...
  <tr>
	<td class="cat" align="center" height="28"><span class="cattitle">&laquo; <a href="{U_PREVIOUS}" class="cattitle">{L_PREVIOUS}</a>&nbsp;-&nbsp;<a href="{U_NEXT}" class="cattitle">{L_NEXT}</a> &raquo;</span></td>
  </tr>
</table>
