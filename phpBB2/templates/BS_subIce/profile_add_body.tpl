...
<!-- BEGIN switch_namechange_allowed -->
      <div class="row gen">
        <div class="col-4 row1 py-1">{L_USERNAME}: *</div>
        <div class="col-8 row2 py-1">
          <input type="text" class="post" style="width:200px" name="username" size="25" maxlength="25" value="{USERNAME}" autocomplete="username" />
        </div>
      </div>
<!-- END switch_namechange_allowed -->
      <div class="row gen">
        ...
        <div class="col-8 row2 py-1">
          <input type="email" class="post" style="width:200px" name="email" size="25" maxlength="255" value="{EMAIL}" autocomplete="email" />
        </div>
      </div>
<!-- BEGIN switch_edit_profile -->
      <div class="row gen">
        <div class="col-4 row1 py-1">{L_CURRENT_PASSWORD}: *<br />
...
<!-- END switch_edit_profile -->
      <div class="row gen">
        <div class="col-4 row1 py-1">{L_NEW_PASSWORD}: *<br />
      ...
      <div class="row gen">
        <div class="col-4 row1 py-1">{L_CONFIRM_PASSWORD}: *<br />
          <span class="gensmall">{L_PASSWORD_CONFIRM_IF_CHANGED}</span>
        </div>
        <div class="col-8 row2 py-1">
	...
	<!-- END switch_confirm -->
      ...
      <div class="row gen">
        ...
        <div class="col-8 row2 py-1"><input type="text" name="dc" class="post" style="width: 200px"  size="10" maxlength="255" value="{DC}" /></div>
      </div>  
