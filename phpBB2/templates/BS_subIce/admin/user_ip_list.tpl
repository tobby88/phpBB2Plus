...
<h2>{L_SHARED}</h2>
<table width="100%" cellpadding="5" cellspacing="1" border="0" class="forumline">
<tr><th>{L_USERNAME}</th><th>{L_POSTS}</th><th>{L_JOINED}</th><th>{L_EMAIL}</th></tr>
<!-- BEGIN userrow -->
<tr><td class="{userrow.ROW_CLASS}"><a href="{userrow.U_USER}">{userrow.USERNAME}</a></td><td class="{userrow.ROW_CLASS}" align="center">{userrow.POSTS}</td><td class="{userrow.ROW_CLASS}">{userrow.JOINED}</td><td class="{userrow.ROW_CLASS}">{userrow.EMAIL}</td></tr>
<!-- END userrow -->
</table>
<br />
