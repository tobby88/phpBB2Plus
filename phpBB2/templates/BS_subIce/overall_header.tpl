...
<!--
                        <li class="nav-item"><a class="nav-link text-nowrap navbr" href="{U_HOME}"><i class="fa-solid fa-house"></i>&nbsp;{L_HOME}</a></li>
-->
                        <li class="nav-item"><a class="nav-link text-nowrap navbr" href="{U_INDEX}"><i class="fa-brands fa-creative-commons-share"></i>&nbsp;{L_FORUM}</a></li>
