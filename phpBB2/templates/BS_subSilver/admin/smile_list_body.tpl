				...
				<tr class="{smiles.ROW_CLASS}">
					...
					<td style="text-align:center;white-space:nowrap"><a href="{smiles.U_SMILEY_EDIT}" title="{L_EDIT}"><img src="../templates/BS_subSilver/admin/images/icon_edit.gif" alt="" /></a> <a href="{smiles.U_SMILEY_DELETE}" title="{L_DELETE}"><img src="../templates/BS_subSilver/admin/images/icon_delete.gif" alt="" /></a></td>
				</tr>
				<!-- END smiles -->
				</tbody>
				</table>
