				...
				<tr class="{ranks.ROW_CLASS}">
					...
					<td style="text-align:center"><a href="{ranks.U_RANK_EDIT}" title="{L_EDIT}"><img src="../templates/prosilver_se/admin/images/icon_edit.gif" alt="" /></a> <a href="{ranks.U_RANK_DELETE}" title="{L_DELETE}"><img src="../templates/prosilver_se/admin/images/icon_delete.gif" alt="" /></a></td>
				</tr>
				<!-- END ranks -->
				</tbody>
				</table>
