        ...
        <div class="row">
          <div class="col">
            ...
            <div class="copyright text-center"><a href="https://www.integramod.com/" title="Style by Integra Team">BS</a> built with <a href="https://getbootstrap.com">Bootstrap 5.3.0</a></div>
          </div>
        </div>
        <!-- /footer -->
