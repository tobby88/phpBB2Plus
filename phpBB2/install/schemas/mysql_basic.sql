...
# -- Themes
INSERT INTO phpbb_themes (themes_id, template_name, style_name, head_stylesheet, body_background, body_bgcolor, body_text, body_link, body_vlink, body_alink, body_hlink, tr_color1, tr_color2, tr_color3, tr_class1, tr_class2, tr_class3, th_color1, th_color2, th_color3, th_class1, th_class2, th_class3, td_color1, td_color2, td_color3, td_class1, td_class2, td_class3, fontface1, fontface2, fontface3, fontsize1, fontsize2, fontsize3, fontcolor1, fontcolor2, fontcolor3, span_class1, span_class2, span_class3, img_size_poll, img_size_privmsg, theme_public) VALUES (1, 'fisubsilversh', 'FI Subsilver Shadow', 'fisubsilversh.css', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'row1', 'row2', '', '', '', '', 0, 0, 0, '', '006600', 'ffa34f', '', '', '', 0, 0, 1);
...
(7, 0, 'Photo Album Addon v2 for phpBB2', 'Integrated phpBB-based photo album and gallery management system.', 'Smartor', 'smartor_xp@hotmail.com', 'http://smartor.is-root.com', '2.0.53', 'No', '', '', 0),
...
(14, 0, 'Birthday Mod', 'Adds birthday and age information to user profiles and posts.', 'Niels', 'ncr@db9.dk', 'http://mods.db9.dk', '1.5.7', 'No', '', '', 0),
...
(54, 0, 'Staff Site Mod', 'Displays the board staff and their roles on a dedicated page.', 'Acid', '', '', '2.2.3', 'No', '', '', 0),
...
(62, 0, 'Recent Topics (third version)', 'Shows recent topics for selectable time periods.', 'Acid', '', '', '1.22', 'No', '', '', 0),
...
(145, 0, 'Admin Userlist', 'User administration list with filtering, safe bulk status, ban and group actions, and Color Groups integration.', 'Brent Pirolli, Eric Faerber; updated by Helter', '', '', '2.1', 'No', '', '', 0),
...
(163, 0, 'Album Hierarchy Mod', 'Adds nested categories to the integrated Photo Album.', 'IdleVoid', 'idlevoid@slater.dk', '', '1.30', 'No', '', '', 0),
...
(178, 0, 'Arcade Mod Plus', 'Integrated arcade framework; game packages and user-generated game data are not distributed.', 'dEfEndEr, Napoleon and contributors', '', 'http://www.phpbb-arcade.com', '2.1.8', 'No', '', '', 0),
(179, 0, 'Nuffload Album Upload', 'Multiple and archive upload support for the integrated photo album.', 'Nuffmon', '', 'http://www.nuffmon.oftheweek.de', '1.4.2', 'No', '', '', 0),
(180, 0, 'DB Maintenance Mod', 'Administration tools for database consistency checks and search-index maintenance.', 'Philipp Kordowich', '', 'http://phpbb.kordowich.net/', '1.3.8', 'No', '', '', 0),
(181, 0, 'Cookie Consent', 'Configurable cookie information banner integrated from IntegraMOD.', 'Helter', '', 'https://www.integramod.com/', '1.0.0', 'No', '', '', 0),
(182, 0, 'Stop Forum Spam', 'Optional IP, email and username checks against the Stop Forum Spam service during registration.', 'gat0r; updated by Helter', '', 'https://www.stopforumspam.com/', '2.1', 'No', '', '', 0),
...
(187, 0, 'Arcade Rewards API', 'Optional integration layer used by Arcade Mod Plus for Cash and Allowance reward systems.', 'Xore, Napoleon, dEfEndEr', '', 'http://www.phpbb-arcade.com', '2.1.6', 'No', '', '', 0),
(189, 0, 'IntegraMOD Social Profile Fields', 'Modern Facebook, Instagram, Pinterest, Twitter/X, Skype, Telegram, LinkedIn, TikTok and Discord profile fields.', 'IntegraMOD contributors', '', 'https://www.integramod.com/', '', 'No', '', '', 0),
(190, 0, 'Ruffle Flash Emulator', 'Bundled WebAssembly runtime for playing preserved Flash arcade games in modern browsers; this is a runtime component, not a phpBB MOD.', 'Ruffle contributors', '', 'https://ruffle.rs/', '0.5.0', 'No', '', '', 0);
...
INSERT INTO `phpbb_ctracker_config` (`ct_config_name`, `ct_config_value`) VALUES ('password_timestamps_split', '1');
...
INSERT INTO `phpbb_ctracker_config` (`ct_config_name`, `ct_config_value`) VALUES ('last_file_scan', '0');
INSERT INTO `phpbb_ctracker_config` (`ct_config_name`, `ct_config_value`) VALUES ('last_checksum_scan', '0');
INSERT INTO `phpbb_ctracker_config` (`ct_config_name`, `ct_config_value`) VALUES ('logsize_logins', '100');
INSERT INTO `phpbb_ctracker_config` (`ct_config_name`, `ct_config_value`) VALUES ('global_message', '');
INSERT INTO `phpbb_ctracker_config` (`ct_config_name`, `ct_config_value`) VALUES ('global_message_type', '1');
INSERT INTO `phpbb_ctracker_config` (`ct_config_name`, `ct_config_value`) VALUES ('logincount', '5');
...
INSERT INTO `phpbb_ctracker_config` (`ct_config_name`, `ct_config_value`) VALUES ('request_limit_enabled', '1');
INSERT INTO `phpbb_ctracker_config` (`ct_config_name`, `ct_config_value`) VALUES ('request_limit_login', '30');
INSERT INTO `phpbb_ctracker_config` (`ct_config_name`, `ct_config_value`) VALUES ('request_limit_register', '10');
...
# Missing Mod Settings defaults used to be created during ordinary page views.
# These complete the three settings already seeded above; existing installs use
# update/mod_settings_defaults.php through the idempotent post-1.53a updater.
INSERT INTO phpbb_config (config_name, config_value) VALUES ('announcement_date_display', '1');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('announcement_date_display_over', '0');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('announcement_display', '1');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('announcement_display_forum', '1');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('announcement_display_forum_over', '0');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('announcement_display_over', '0');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('announcement_duration', '7');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('announcement_forum', '1');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('announcement_forum_over', '0');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('announcement_prune_strategy', '0');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('announcement_split', '1');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('announcement_split_over', '0');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('calendar_birthday', '1');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('calendar_birthday_over', '0');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('calendar_display_open', '0');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('calendar_display_open_over', '0');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('calendar_forum', '1');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('calendar_forum_over', '0');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('calendar_header_cells', '7');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('calendar_header_cells_over', '0');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('calendar_nb_row', '5');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('calendar_nb_row_over', '0');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('calendar_text_length', '200');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('calendar_title_length', '30');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('calendar_week_start', '1');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('calendar_week_start_over', '0');
...
INSERT INTO phpbb_config (config_name, config_value) VALUES ('icon_per_row', '10');
...
INSERT INTO phpbb_config (config_name, config_value) VALUES ('max_posts', '0');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('max_topics', '0');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('max_users', '0');
...
INSERT INTO phpbb_config (config_name, config_value) VALUES ('split_news_over', '0');
...
INSERT INTO phpbb_config (config_name, config_value) VALUES ('use_ajax_edit_over', '0');
INSERT INTO phpbb_config (config_name, config_value) VALUES ('use_ajax_preview_over', '0');
