...
(7, 0, 'Photo Album Addon v2 for phpBB2', 'This is a phpBB-based photo album/gallery management system.', 'Smartor', 'smartor_xp@hotmail.com', 'http://smartor.is-root.com', '2.0.53', 'No', '', '', 0),
...
(14, 0, 'Birthday Mod', 'This mod will add a birthday field into your user\\\'s profile and make users age viewable to others when viewing posts.', 'Niels', 'ncr@db9.dk', 'http://mods.db9.dk', '1.5.7', 'No', '', '', 0),
...
(54, 0, 'Staff Site Mod', 'An external site to display who is Mod or Admin on your board. Some additional infos. (see optional part to add other columns)', 'Acid', '', '', '2.2.3', 'No', '', '', 0),
...
(62, 0, 'Recent Topics (third version)', 'Shows recent topics on an extra site (last 24 hour, last week,yesterday, last x days, today)', 'Acid', '', '', '1.22', 'No', '', '', 0),
...
(163, 0, 'Album Hierarchy Mod', 'This mod allows to create multiple sub categories of each (sub) categories in the Photo Album Addon', 'IdleVoid', 'idlevoid@slater.dk', '', '1.30', 'No', '', '', 0),
