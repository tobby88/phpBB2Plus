...
$user_posts_per_page = $board_config['posts_per_page'];
$user_topics_per_page = $board_config['topics_per_page'];
...
$template->assign_vars(array(
	...
	'DATE_FORMAT_SELECT' => dateformatselect($user_dateformat, $user_timezone),
