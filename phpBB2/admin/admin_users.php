...
//
	...
	if( isset( $_POST['submit'] ) )
	{
		...
		$profile_names = array();
		$profile_assignments = phpbb_profile_field_assignments($profile_data, $_POST, $profile_names);
...
{ 
   ...
   if (!$result = $db->sql_query($sql) ) 
      message_die(GENERAL_ERROR, "Couldn't remove ban_userid info into database", "", __LINE__, __FILE__, $sql); 
			...
			$admin_profile_scope->validate_identity($username_sql !== '' ? $username : $this_userdata['username'], $email, $user_style);
