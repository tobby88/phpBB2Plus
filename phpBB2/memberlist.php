...
if ( $row = $db->sql_fetchrow($result) )
{
	...
	do
	{
		...
		// FLAGHACK-start
		$flag_image_name = phpbb_profile_image_name($row['user_from_flag']);
		$flag = ( $flag_image_name ) ? "&nbsp;<img src=\"images/flags/" . $flag_image_name . "\" alt=\"" . $flag_image_name . "\">" : '&nbsp;<img src="images/flags/blank.gif" alt="">';
		// FLAGHACK-end
		...
		$gallery_label = sprintf($lang['Personal_Gallery_Of_User'], phpbb_stored_text($row['username']));
