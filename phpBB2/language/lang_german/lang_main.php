...
$lang['Social_facebook_explain'] = 'Profilname oder vollständige Profil-URL.';
$lang['Social_instagram_explain'] = 'Benutzername oder vollständige Profil-URL.';
$lang['Social_linkedin_explain'] = 'Öffentlicher Profilname (hinter /in/) oder vollständige Profil-URL.';
$lang['Social_twitter_explain'] = 'Benutzername oder vollständige Profil-URL bei X/Twitter.';
$lang['Social_telegram_explain'] = 'Benutzername oder vollständiger t.me-Link.';
$lang['Social_tiktok_explain'] = 'Benutzername oder vollständige Profil-URL.';
$lang['Social_discord_explain'] = 'Discord-Benutzername oder numerische Benutzer-ID; nur die ID ergibt einen anklickbaren Profil-Link.';
$lang['Social_signal_explain'] = 'Exakten Signal-Benutzernamen einschließlich Ziffern oder den in Signal kopierten Freigabelink eingeben; nur der Freigabelink ist anklickbar.';
$lang['Social_threema_explain'] = 'Achtstellige Threema-ID oder vollständigen threema.id-Link eingeben.';
...
$lang['Group_storage_failed'] = 'Die Gruppenänderung konnte nicht bestätigt werden. Bitte lade die Gruppe neu und prüfe ihre Mitgliedschaften und Berechtigungen, bevor du es erneut versuchst.';
$lang['Group_no_moderator'] = 'Keine Gruppenleitung zugewiesen';
...
$lang['User_reference_cleanup_failed'] = 'Die Kontobereinigung konnte nicht abgeschlossen werden. Bitte wende dich an einen Administrator; der Vorgang kann teilweise ausgeführt worden sein.';
...
$lang['Credits'] = 'Komponenten und Danksagungen';
...
$lang['Prune_atomic_unconfirmed'] = 'Der Abschluss dieses Forenvorgangs konnte nicht bestätigt werden. Prüfe vor einem erneuten Versuch dessen aktuellen Inhalt; die Datenbanktransaktion könnte ohne übermittelte Bestätigung abgeschlossen worden sein. Für diesen nicht bestätigten Vorgang wurden keine Anhangdateien entfernt.';
$lang['Prune_batch_interrupted'] = '%d vorherige Forenvorgänge wurden erfolgreich abgeschlossen und nicht zurückgerollt. Prüfe vor einem erneuten Versuch das betroffene Forum; bitte nicht die gesamte Sammelbereinigung ungeprüft wiederholen.';
...
$lang['Moderation_state_failed'] = 'Die Moderationsaktion konnte nicht bestätigt werden. Themenänderungen und Aktionsprotokoll werden gemeinsam gespeichert; bei einem Verbindungsabbruch zum Abschluss prüfe bitte vor einem erneuten Versuch ihren Zustand.';
$lang['Moderation_state_storage'] = 'Das Ändern des Themenstatus benötigt InnoDB-Tabellen mit modernem UTF-8-Speicherformat. Bitte führe vor einem erneuten Versuch die dokumentierten Speicherformat- und UTF-8-Updates aus.';
...
$lang['Moderation_move_failed'] = 'Das vollständige Verschieben konnte nicht bestätigt werden. Bei einer verlorenen Commit-Antwort kann der gesamte Vorgang bereits gespeichert sein. Bitte lade die Seite neu und prüfe Themen, Zähler und Aktionsprotokoll vor einem erneuten Versuch.';
$lang['Moderation_move_storage'] = 'Das Verschieben benötigt InnoDB-Tabellen mit modernem UTF-8-Speicherformat. Bitte führe vor einem erneuten Versuch die dokumentierten Speicherformat- und UTF-8-Updates aus.';
...
$lang['Moderation_split_failed'] = 'Das Abtrennen konnte nicht bestätigt werden. Themen, Beiträge, Zähler und Aktionsprotokoll werden gemeinsam gespeichert; bei einem Verbindungsabbruch zum Abschluss prüfe bitte vor einem erneuten Versuch ihren Zustand.';
$lang['Moderation_split_storage'] = 'Das Abtrennen benötigt InnoDB-Tabellen mit modernem UTF-8-Speicherformat. Bitte führe vor einem erneuten Versuch die dokumentierten Speicherformat- und UTF-8-Updates aus.';
...
$lang['Registration_mail_failed'] = 'Dein Konto wurde gespeichert, aber eine Benachrichtigung konnte nicht zugestellt werden. Falls eine Freischaltung nötig ist, wende dich bitte an die Administration; registriere dich nicht erneut.';
