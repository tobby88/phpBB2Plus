...
$lang['xs_import_failed'] = 'Der Style-Import konnte nicht bestätigt werden. Eine teilweise Style-Registrierung wurde nicht gespeichert. Dateien können bereits übertragen worden sein; bitte das Ziel vor einem erneuten Versuch prüfen. Das Quellarchiv nicht löschen.';
 ...
 *   creator [German]     : http://www.phpbb2.de
 *
 ***************************************************************************/
...
$lang['xs_remove_failed'] = 'Das Entfernen konnte nicht abgeschlossen oder bestätigt werden. Lade die Seite vor einem erneuten Versuch neu. Datenbankänderungen und Dateibereinigung sind getrennte Schritte; einige ungenutzte Dateien können bereits entfernt worden sein. Prüfe Administratorsitzung, Datenbankmigration, Dateisystem-/FTP-Rechte und Cache-Verzeichnis. Nicht mehr registrierte Template-Verzeichnisse können unten bereinigt werden.';
$lang['xs_remove_protected'] = 'Der aktuelle Standardstyle sowie gemeinsam genutzte oder reservierte Template-Dateien dürfen nicht entfernt werden.';
$lang['xs_orphan_files'] = 'Nicht registriertes Template-Verzeichnis (Bereinigung/Wiederholung)';
$lang['xs_uninstall_confirm'] = 'Möchtest Du diesen Style wirklich deinstallieren?';
$lang['xs_uninstall_files_confirm'] = 'Möchtest Du diesen Style wirklich deinstallieren und seine Template-Dateien dauerhaft löschen?';
...
$lang['xs_config_def_template_explain'] = 'Wenn eine benötigte tpl-Datei im aktuellen Template-Verzeichnis fehlt, kann das Template-System im konfigurierten Ausweichverzeichnis danach suchen. FI Subsilver Shadow ist das mitgelieferte Ausweich-Template. Ein leeres Feld deaktiviert diese Funktion.';
