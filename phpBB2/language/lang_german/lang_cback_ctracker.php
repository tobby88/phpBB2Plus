...
$lang['ctracker_settings_e8']			  = 'Aktiviert zusätzlich zum allgemeinen IP-Limit eine engere Begrenzung für die Kombination aus serverseitig ermittelter IP und eingegebenem Benutzernamen. Andere Besucher können dadurch keinen Sperr- oder CAPTCHA-Zustand am Konto verursachen.';
...
$lang['ctracker_settings_m10']			  = 'Fehlversuche je IP und Benutzername';
$lang['ctracker_settings_e10']			  = 'Nach dieser Zahl fehlgeschlagener Versuche wird nur die betroffene Kombination für den Rest eines 15-Minuten-Fensters gedrosselt. Das Benutzerkonto selbst bleibt frei.';
...
$lang['ctracker_settings_m14']			  = 'Posting-Drosselung';
$lang['ctracker_settings_e14']			  = 'Begrenzt kurzfristige Beitragsserien pro Benutzerkonto. Eine Überschreitung führt nur zu einer kurzen Wartezeit und niemals automatisch zu einer Kontosperre.';
$lang['ctracker_settings_m15']			  = 'Posting-Zeitfenster';
$lang['ctracker_settings_e15']			  = 'Zeitfenster, in dem neue Themen und Antworten pro Benutzerkonto gezählt werden (in Sekunden).';
$lang['ctracker_settings_m16']			  = 'Beiträge je Zeitfenster';
$lang['ctracker_settings_e16']			  = 'Höchste Zahl neuer Themen und Antworten im eingestellten Zeitfenster. Weitere Versuche werden mit HTTP 429 bis zum nächsten Fenster abgewiesen.';
 ...
 */
$lang['ctracker_fscan_complete']		  = 'Der Dateiscan wurde erfolgreich ausgeführt. Unter "Ergebnisse anzeigen" findest Du den neuen Bericht. Die vorherige vollständige Ergebnisliste wurde erst nach erfolgreichem Abschluss ersetzt.<br /><br /><b>Hinweis:</b> Die Prüfung erkennt strukturelle Auffälligkeiten, beweist aber weder Sicherheit noch einen Angriff. Prüfe gemeldete Dateien im Kontext; Quelltext-Kommentare können die Prüfung nicht mehr pauschal deaktivieren.';
...
$lang['ctracker_ipb_description']		  = 'Hier kannst Du exakte Einträge oder Platzhaltermuster für die verifizierte Client-IP, den User-Agent und einen serverseitig gelieferten Hostnamen verwalten. Ein Stern (*) steht für beliebige Zeichen; IPv4- und IPv6-Netze können außerdem in CIDR-Schreibweise angegeben werden, zum Beispiel 192.0.2.0/24 oder 2001:db8::/32.<br /><br /><b>WARNUNG:</b> Sperre nicht Deine eigene IP-Adresse oder Deinen User-Agent, sonst sperrst Du Dich selbst aus dem Forum aus.';
...
$lang['ctracker_ma_name_1']				  = 'Struktur- und Exploit-Signaturprüfung für Anfragen';
$lang['ctracker_ma_name_2']				  = 'Konfiguration und zentrale Anfragedrosselung';
$lang['ctracker_ma_name_3']				  = 'IP-, CIDR-, Hostname- und User-Agent-Blockliste';
$lang['ctracker_ma_name_4']				  = 'Atomarer Datenbankspeicher für Anfragedrosselung';
...
$lang['ctracker_ma_scheck_1']			  = 'PHP-Laufzeit';
$lang['ctracker_ma_scheck_2']			  = 'Zentrale Anfragedrosselung';
$lang['ctracker_ma_scheck_3']			  = 'Adaptives Passwort-Hashing';
$lang['ctracker_ma_scheck_4']			  = 'HTTPS-Transport';
$lang['ctracker_ma_scheck_4a']			  = '&raquo; Visuelle Bestätigung';
$lang['ctracker_ma_scheck_4b']			  = '&raquo; Accountaktivierung';
$lang['ctracker_ma_scheck_5']			  = 'Integrierte CrackerTracker-Laufzeit';
$lang['ctracker_ma_chmod']				  = '<b>Logdatei les- und schreibbar:</b> ';
...
$lang['ctracker_ma_desc2']				  = '<b>Veraltete Standardregeln entfernen</b><br />Entfernt nur die 2006 mitgelieferten User-Agent-Regeln. Sie sind leicht zu umgehen und können legitime Clients treffen. Eigene IP-, CIDR-, Hostname- und User-Agent-Regeln bleiben erhalten.';
...
$lang['ctracker_rec_subhead']			  = 'Hier kannst Du einen Snapshot der phpBB-Konfiguration anlegen oder die zuletzt vollständig gespeicherten Werte wiederherstellen. Bei aktivierter automatischer Sicherung wird vor einer Änderung der allgemeinen Forenkonfiguration ein neuer Snapshot erstellt. Der bisherige Snapshot bleibt erhalten, falls dieser Vorgang abbricht. Forensperre, interne Versionsstände, Suchindex-Fortschritt und Wiederherstellungs-Token bleiben beim Wiederherstellen unverändert.<br /><br /><b>Wichtig:</b> Dies ist kein vollständiges Datenbankbackup und ersetzt auch keines. Die frühere öffentlich erreichbare CrackerTracker-Notfallkonsole ist aus Sicherheitsgründen dauerhaft deaktiviert. Nutze bei verlorenem ACP-Zugang ein geprüftes Datenbankbackup bzw. das separate DB-Wartungswerkzeug.';
...
$lang['ctracker_fdisplay_n'] 			  = '<a href="http://www.cback.de" target="_blank" rel="noopener noreferrer">Sicherheit</a> durch <a href="http://www.cback.de" target="_blank" rel="noopener noreferrer">CBACK CrackerTracker</a>.';
$lang['ctracker_fdisplay_c'] 			  = 'Geschützt durch <a href="http://www.cback.de" target="_blank" rel="noopener noreferrer">CBACK CrackerTracker</a><br /><b>%s</b> abgewehrte Angriffe.';
...
$lang['ctracker_settings_fallback'] = 'Ungültige gespeicherte Werte bei: %s. Vorläufig werden dafür die Standardwerte verwendet; die Datenbank wurde nicht verändert. Bitte prüfe und speichere die Einstellungen im jeweils zuständigen Bereich.';
...
$lang['ctracker_binf_spammer']	= 'Zum Schutz vor automatisierten Beitragsserien sind höchstens %s Beiträge innerhalb von %s Sekunden möglich. Bitte warte noch %s Sekunden; Dein Konto bleibt unverändert.';
$lang['ctracker_sendmail_info'] = 'Aus Sicherheitsgründen kannst Du nur alle %s Minuten eine E-Mail senden. Bitte warte noch %s Sekunden.';
