...
$lang['Maintenance_pm_journal_unavailable'] = 'The PM repair journal is unavailable. Check database access and run update/update_from_153a.php before using this maintenance operation.';
$lang['Maintenance_pm_journal_changed'] = 'The pending PM cleanup or its source data changed. No further cleanup was performed. Open maintenance again to recheck the current state.';
$lang['Maintenance_pm_repair_recovered'] = 'Interrupted PM cleanup operations completed: %d.';
$lang['Maintenance_pm_repair_cancelled'] = 'Cleanup operations with changed source data: %d. Restored messages and changed attachment registrations were not deleted using old job data. Review any remaining orphaned attachments separately.';
...
$lang['Maintenance_poll_review'] = '%d poll records still need review (up to 100 shown). Missing answers, duplicate or invalid answer IDs, and multiple polls for one topic cannot be reconstructed automatically. These records, their results and vote history were retained. Restore the missing source data or review the conflicting polls before editing them; do not guess or renumber answers with existing votes.';
...
$lang['Number_records'] = 'Records (estimated from table statistics)';
$lang['Maintenance_innodb_check'] = 'InnoDB: checking instead of REPAIR TABLE. A damaged table may require restoring a backup; no automatic repair is claimed.';
...
$lang['rdb_success'] = 'Table operations were confirmed. InnoDB tables were checked, not repaired with REPAIR TABLE.';
