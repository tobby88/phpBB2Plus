...
$lang['Album_personal_gallery_explain'] = 'On this page, you can choose which usergroups have the right to create and view personal galleries. These settings only take affect when you set "PRIVATE" for "Allowed to create personal gallery for users" or "Who can view personal galleries" in Album Configuration screen';
