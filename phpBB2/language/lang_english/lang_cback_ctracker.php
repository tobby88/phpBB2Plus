...
$lang['ctracker_settings_e8']			  = 'In addition to the general IP limit, this enables a tighter limit for the server-verified IP and submitted username pair. Other visitors can no longer impose a lock or CAPTCHA state on the account.';
...
$lang['ctracker_settings_m10']			  = 'Failures per IP and username';
$lang['ctracker_settings_e10']			  = 'After this many failed attempts, only the affected pair is throttled for the remainder of a 15-minute window. The account itself remains available.';
...
$lang['ctracker_settings_m14']			  = 'Posting rate protection';
$lang['ctracker_settings_e14']			  = 'Limits short posting bursts per user account. Exceeding the limit only causes a short wait and never automatically locks or bans the account.';
$lang['ctracker_settings_m15']			  = 'Posting time window';
$lang['ctracker_settings_e15']			  = 'Window in which new topics and replies are counted per user account (in seconds).';
$lang['ctracker_settings_m16']			  = 'Posts per time window';
$lang['ctracker_settings_e16']			  = 'Maximum new topics and replies in the configured window. Further attempts receive HTTP 429 until the next window.';
...
$lang['ctracker_settings_m43']             = 'Content actions per 5 minutes';
$lang['ctracker_settings_e43']             = 'Separately limits posts, private messages, shoutbox entries, comments, ratings and game scores without consuming the technical write limit.';
...
$lang['ctracker_ipb_description']		  = 'Here you can manage exact or wildcard block entries for verified client IP addresses, User-Agent values and server-provided remote hostnames. An asterisk (*) matches any characters; IPv4 and IPv6 networks can also use CIDR notation such as 192.0.2.0/24 or 2001:db8::/32.<br /><br /><b>CAUTION</b> Do not block your own IP address or User-Agent, otherwise you will lock yourself out of the forum.';
...
$lang['ctracker_ma_name_1']				  = 'Structural request and exploit-signature protection';
$lang['ctracker_ma_name_2']				  = 'Configuration and central rate-limit engine';
$lang['ctracker_ma_name_3']				  = 'IP, CIDR, hostname and User-Agent blocklist';
$lang['ctracker_ma_name_4']				  = 'Atomic rate-limit database store';
...
$lang['ctracker_ma_scheck_1']			  = 'PHP runtime';
$lang['ctracker_ma_scheck_2']			  = 'Central request rate limits';
$lang['ctracker_ma_scheck_3']			  = 'Adaptive password hashing';
...
$lang['ctracker_ma_scheck_5']			  = 'Integrated CrackerTracker runtime';
$lang['ctracker_ma_chmod']				  = '<b>Log file readable and writable:</b> ';
...
$lang['ctracker_ma_desc2']				  = '<b>Remove obsolete factory rules</b><br />Removes only the User-Agent rules shipped in 2006. They are easy to evade and can block legitimate clients. Your own IP, CIDR, hostname and User-Agent rules are preserved.';
 ...
 */
$lang['ctracker_error_blocklist_value'] = 'Invalid block entry. Use valid UTF-8 text with 1 to 200 bytes and at most eight asterisks (*), without line breaks or control characters. Nothing was saved.';
$lang['ctracker_error_global_message'] = 'Invalid announcement. Use at most 255 characters of valid UTF-8 text, without hidden control characters. Nothing was saved.';
$lang['ctracker_glob_msg_invalid_type'] = 'Invalid announcement type. Please select text or link. Nothing was saved.';
...
$lang['ctracker_settings_fallback'] = 'Invalid stored values for: %s. Defaults are being used temporarily; the database has not been changed. Please review and save these settings in their respective configuration sections.';
...
$lang['ctracker_binf_spammer']	= 'To protect against automated posting bursts, up to %s posts are allowed within %s seconds. Please wait another %s seconds; your account remains unchanged.';
$lang['ctracker_sendmail_info'] = 'For safety reasons you may send an e-mail only every %s minutes. Please wait another %s seconds.';
