...
$lang['Rcatexplain'] = 'You can reorder categories to change the position they are displayed in on the main page. To reorder the categories, change the numbers to the order you want them shown. 1 will be shown first, 2 will be shown second, etc. This does not affect sub-categories.';
...
$lang['Category_auth_explain'] = 'Here you can alter the authorization levels of each category. Remember that changing the permission level of a category will affect which users can carry out the various operations within them.';
...
$lang['Forbidden_extensions_explain'] = 'Here you can add or delete the forbidden extensions. Separate each extension with a comma.';
