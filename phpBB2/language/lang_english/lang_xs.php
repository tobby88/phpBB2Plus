...
$lang['xs_remove_failed'] = 'Removal could not be completed or confirmed. Reload before retrying. Database changes and file cleanup are separate steps; some unused files may already have been removed. Check your administration session, database migration, filesystem/FTP permissions and cache directory. Unregistered template directories can be cleaned up below.';
$lang['xs_remove_protected'] = 'The current default style and shared or reserved template files cannot be removed.';
$lang['xs_orphan_files'] = 'Unregistered template directory (cleanup/retry)';
$lang['xs_uninstall_confirm'] = 'Are you sure you want to uninstall this style?';
$lang['xs_uninstall_files_confirm'] = 'Are you sure you want to uninstall this style and permanently remove its template files?';
...
$lang['xs_edit_templates_disabled'] = 'The web-based template editor has been disabled. Manage template files through the source repository and deployment process.';
