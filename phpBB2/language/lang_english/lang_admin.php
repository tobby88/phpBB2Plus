...
$lang['Removal_pending_exists'] = 'A pending removal already exists for this account. Check user management, Account Actions or user pruning; a request can only be resumed in its original administration module.';
...
$lang['Profile_retirement_explain'] = 'These fields are no longer displayed or editable. Their definitions and saved user values are retained for recovery; removing a field does not erase its data. Permanent erasure requires the separate offline CLI tool update/purge_profile_fields.php with a verified backup and stopped/drained web/cron requests (see README).';
...
$lang['Acl_storage_failed'] = 'The permission change could not be confirmed. Please reload the page and check the affected accounts and permissions before trying again.';
$lang['Admin_profile_save_failed'] = 'The profile change could not be confirmed. Reload the account and check its settings before trying again.';
$lang['Admin_profile_self_disable'] = 'You cannot disable or block the account you are currently using to administer the forum.';
...
$lang['Admin_Users_List_explain'] = 'Manage users with safe sorting, filtering and bulk status, ban and group actions. Delete users through the individual user editor so all phpBB2 Plus data is cleaned consistently.';
$lang['Admin_userlist_show'] = 'Users per page';
$lang['Admin_userlist_bulk_action'] = 'Selected users';
$lang['Admin_userlist_activate'] = 'Activate';
$lang['Admin_userlist_deactivate'] = 'Deactivate';
$lang['Admin_userlist_add_group'] = 'Add to group';
$lang['Admin_userlist_select_group'] = 'Select group';
$lang['Admin_userlist_invalid_group'] = 'Please select a valid user group.';
$lang['Admin_userlist_banned'] = 'banned';
$lang['Admin_userlist_updated'] = 'The selected users have been updated.';
$lang['Admin_userlist_invalid_selection'] = 'The user selection or group ID is invalid. Please reload the list.';
$lang['Admin_userlist_storage_failed'] = 'The bulk action could not be fully saved. Changes already applied remain in place. Please check the users and repeat any outstanding changes.';
$lang['Admin_userlist_result'] = '%d users updated; %d unchanged (already in the requested state, protected, or no longer present).';
$lang['Click_return_userlist'] = 'Click %shere%s to return to the user list.';
$lang['Logs'] = 'Logs';
$lang['Logs Actions'] = 'Moderation actions';
$lang['Log_action_title'] = 'Moderation action log';
$lang['Log_action_explain'] = 'Records topic and post changes performed by moderators and administrators. This integrates Log Actions MOD 1.1.6 and Enhanced Log Actions.';
$lang['Log_action'] = 'Action';
$lang['Log_topic'] = 'Topic';
$lang['Log_user'] = 'Performed by';
$lang['Log_ip'] = 'IP address';
$lang['Log_date'] = 'Date';
$lang['Log_delete_selected'] = 'Delete selected entries';
$lang['Log_prune'] = 'Delete entries older than';
$lang['Log_days'] = 'days';
$lang['Log_invalid_session'] = 'The administration session is no longer valid. Please reload the page.';
$lang['Unban'] = 'Unban';
$lang['Log_action_delete'] = 'Deleted';
$lang['Log_action_move'] = 'Moved';
...
$lang['Log_action_normal'] = 'Changed to normal topic';
$lang['Registration IP'] = 'Registration IP';
$lang['Registration_IP'] = 'Registration IP';
$lang['Registration_IP_explain'] = 'Shows the server-verified IP address recorded when an account was registered and other accounts registered from the same address. Forwarding headers are intentionally not trusted.';
$lang['Registration_IP_address'] = 'Registration IP address';
$lang['Registration_IP_hostname'] = 'Hostname';
$lang['Registration_IP_shared'] = 'Accounts registered from the same IP address';
$lang['Registration_IP_resolve'] = 'Resolve now';
$lang['Registration_IP_not_resolved'] = 'Not resolved (avoids delaying registration)';
$lang['Registration_IP_no_hostname'] = 'No reverse-DNS name found';
$lang['Registration_IP_unknown'] = 'Not recorded (account predates this feature)';
...
$lang['Plus'] = 'Plus';
$lang['Portal'] = 'Portal';
$lang['Banner'] = 'Banners / portal links';
