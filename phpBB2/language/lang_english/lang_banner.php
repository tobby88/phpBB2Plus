...
$lang['Banner_size_explain'] = "if the size is set to zero, the image will display its default pixel size";
...
$lang['Banner_owner_explain']="This user may manage the banner - (not implemented yet)";
...
$lang['Banner_weigth_explain'] = "How often this banner should be shown, relative to other active banners at the current time. (1-99)";
...
$lang['Banner_filter_explain'] = 'Hide this banner after the user has clicked on it';
$lang['Banner_filter_time'] = 'Inactive click time';
$lang['Banner_filter_time_explain'] = 'Number of seconds the banner becomes inactive after a user clicks on it, if banner filter is enabled, the banner will not show in this time';
