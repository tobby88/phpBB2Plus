...
$lang['Posting_submit_unconfirmed'] = 'Publication of your post could not be confirmed. Keep a copy of your draft and check the topic before submitting again to avoid a duplicate post.';
$lang['Posting_submit_denied'] = 'Your current permissions do not allow publishing this post. Keep a copy of your draft and reload the forum.';
$lang['Posting_submit_upgrade'] = 'Posting requires the current InnoDB/utf8mb4 database format. Please ask an administrator to complete the database updates.';
$lang['Full_edit_poll_options'] = 'The poll options are invalid or exceed the storage limits. Keep your draft and review the option numbers and text lengths.';
$lang['Full_edit_poll_ambiguous'] = 'This poll contains duplicate or invalid option numbers. No changes were saved. Please ask an administrator to review the poll without discarding its votes.';
...
$lang['PM_write_pending'] = 'This message has not finished saving. Please try again later; its sender can resume the interrupted operation.';
$lang['PM_resume_title'] = 'Unfinished private messages';
$lang['PM_resume_explain'] = 'These accepted requests have not finished saving. Resume the recorded request without sending a second message. Completed changes cannot be undone here.';
$lang['PM_resume'] = 'Resume saving';
...
$lang['Credits'] = 'Components and Credits';
...
$lang['Prune_atomic_unconfirmed'] = 'Completion of this forum operation could not be confirmed. Check its current contents before retrying; the database transaction may have completed without its acknowledgement. No attachment files were removed for this unconfirmed operation.';
...
$lang['Moderation_state_storage'] = 'Changing topic states requires InnoDB tables with modern UTF-8 storage. Please complete the documented storage and UTF-8 upgrades before retrying.';
...
$lang['Moderation_move_failed'] = 'The complete move could not be confirmed. If the commit reply was lost, the entire move may already be saved. Please reload and check the topics, counters and action log before retrying.';
$lang['Moderation_move_storage'] = 'Moving topics requires InnoDB tables with modern UTF-8 storage. Please complete the documented storage and UTF-8 upgrades before retrying.';
...
$lang['Moderation_split_failed'] = 'The split could not be confirmed. Topics, posts, counters and the action log are saved together; if the connection was lost at completion, please check their state before retrying.';
$lang['Moderation_split_storage'] = 'Splitting topics requires InnoDB tables with modern UTF-8 storage. Please complete the documented storage and UTF-8 upgrades before retrying.';
...
$lang['Public_profile_changed'] = 'Your session, account details or profile rules have changed. Please sign in again if necessary and reload the profile form.';
$lang['Signature_save_failed'] = 'Saving your signature could not be confirmed. Reload the signature editor before trying again.';
$lang['Registration_changed'] = 'Registration rules changed while your form was being processed. Please reload the registration form and try again.';
$lang['Registration_storage_upgrade'] = 'Registration requires the current InnoDB and UTF-8 database updates. Please contact the forum administrator.';
$lang['Registration_save_failed'] = 'Registration could not be confirmed. Please check whether the account already exists before trying again.';
$lang['Registration_mail_failed'] = 'Your account was saved, but a notification could not be delivered. If activation is required, please contact the forum administrator; do not register again.';
