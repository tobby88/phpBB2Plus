...
try
{
	...
	mutation_check(strpos(substr($source, $end), 'phpbb_submit_post_delete($GLOBALS[\'db\'], $mode, $forum_id, $topic_id, $post_id, $poll_id)') !== false, 'Normal delete controller delegates to the transactional storage worker');
