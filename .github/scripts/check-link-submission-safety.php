...
$checks = array(
	...
	'link listing URLs use the shared external boundary' => strpos($listing, 'phpbb_normalize_external_url($value)') !== false,
    ...
    'submitted URLs use the shared external boundary' => strpos($submission, 'phpbb_normalize_external_url($value)') !== false,
