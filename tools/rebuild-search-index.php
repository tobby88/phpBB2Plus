 ...
 *
 * Dry-run: php tools/rebuild-search-index.php
 * Apply:   php tools/rebuild-search-index.php --apply --backup-confirmed
 */
...
$_SERVER['SCRIPT_NAME'] = '/tools/rebuild-search-index.php';
