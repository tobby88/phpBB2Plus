...
- Preflight the complete XS style archive before extracting or staging files.
  ...
  Accept root/nested directory records generated by the preserved XS exporter;
  never create directories during preview. Full archive publication/database
  registration atomicity remains a separate follow-up.
